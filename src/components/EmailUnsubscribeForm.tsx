...
export default function EmailUnsubscribeForm() {
  ...
  if (status === "success") {
    return (
      <p role="status" className="flex items-center justify-center gap-2 text-sm font-semibold text-green-700">
        <Check size={18} aria-hidden="true" />
        You&rsquo;re unsubscribed — that email won&rsquo;t receive any more notifications from MMSPL.
      </p>
    );
  }
