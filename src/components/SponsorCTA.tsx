  ...
  return (
    <section aria-labelledby="sponsor-heading" className="bg-black py-8 text-white md:py-10">
      <div className="mx-auto max-w-7xl px-5 text-center">
        <h2 id="sponsor-heading" className="mb-4 text-3xl sm:text-4xl">
        ...
        <Link
          href="/contact"
          className="inline-flex h-10 items-center justify-center gap-2 whitespace-nowrap rounded-[3px] bg-brand px-8 py-4 text-lg font-bold text-white transition-colors hover:bg-brand-700"
        >
          Become a Sponsor
        </Link>
      </div>
